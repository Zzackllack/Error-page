...
export function NotFound({
  ...
  return (
    <div className={`relative text-center z-[1] ${isBackground ? 'h-full flex items-center justify-center' : 'pt-52'}`}>
      <h1 className={`mt-4 text-balance ${isBackground ? 'text-[30rem]' : 'text-5xl sm:text-7xl'} font-semibold tracking-tight text-primary`}>
        {title}
      </h1>
